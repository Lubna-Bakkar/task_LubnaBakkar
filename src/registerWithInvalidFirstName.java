...
public class registerWithInvalidFirstName extends parameters{
//if_the_first_name_less_than_3_characters
	@Test()
	public void RegisterInvalid_Firstname() throws InterruptedException{
		...
		driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div/div/div[1]/div/form/div[1]/div[1]/input")).sendKeys(("a"));
	...
	String number=obj.randomInt(7);
		...
		String	expectError="First name must be at least 3 characters";
